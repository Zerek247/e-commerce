...
function SearchContent() {
  ...
  return (
    <div className="fade-in max-w-[1400px] mx-auto px-6 py-16">
      <div className="mb-12">
        <p className="eyebrow mb-3">Search results</p>
        <h1 className="font-display text-4xl md:text-5xl text-ink mb-3">
          {query ? <>Results for <span className="italic">"{query}"</span></> : 'Search'}
        </h1>
      ...
      {results.length === 0 ? (
        <div className="text-center py-20">
          <div className="w-16 h-16 border border-nude-300 rounded-full flex items-center justify-center mx-auto mb-6">
            <Search size={20} strokeWidth={1.5} className="text-ink-mid" />
          </div>
